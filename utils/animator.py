...
class Animator:
    def __init__(self, title: str, count, idx_loc, anchor_pos, target_pos, estimated_target_pos, measured_target_pos_1,
        ...
        self.ax_animation.legend(loc="upper left")
    ...
    def _animate(self, frame):
        if self.is_manual:
            ...
            return self.line_actual_target, self.line_estimated,\
                   self.line_measured1, self.line_measured2

        # Calls update due to change
        self.slider.set_val(frame)
        self.is_manual = False
        return self.line_actual_target, self.line_estimated, self.line_measured1, self.line_measured2
    ...
    def _initialize_error_figures(self):
        ...
        axs[0][1].set_xlim(0)
        axs[0][1].set_ylabel("Distance (meter)")
